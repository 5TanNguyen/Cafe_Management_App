...
export default function ProfileScreen({ navigation }) {
  ...
  const PROFILE_PICTURE =
    "https://besthqwallpapers.com/Uploads/6-4-2020/127311/lockheed-martin-f-16i-sufa-general-dynamics-f-16-fighting-falcon-f-16i-sufa-israeli-fighter-israeli-air-force.jpg";
  ...
  const dangki_Lich = (item) => {
    ...
    axios({
      url:
        "http:/192.168.2.32:5555/dangkiLich?u_id=" + u_id + "&cd_id=" + cd_id,
      method: "GET",
    })
      .then((res) => {
        get_Calendar();
  ...
  return (
    <SafeAreaView>
      ...
      <Modal animationType="slide" visible={visible_Calendar}>
        <SafeAreaView>
          <View style={styles.form_wallet}>
            <Text style={styles.label}>Lịch Làm</Text>

            <TouchableOpacity onPress={handleVisibleCalendar}>
            ...
            <ScrollView style={styles.sv_tk}>
              {calendar?.map((item, index) => {
                return (
                  <View
                    style={[styles.item_table, { flexDirection: "row" }]}
                    key={index}
                  >
                    <View
                      style={{
                    ...
                    >
                      <Text style={styles.txt_table}>
                        ...
                        >
                          ...
                          >
                            {item.cd_date.toString().split("T")[0]}
                          </Text>
                          <Text style={[styles.txt_name, { marginLeft: 10 }]}>
                            {item.s_name} | {item.hours}h{" "}
                          </Text>
                        </View>
                        {"\n"}
                      </Text>
                      ...
                      >
                        <Text style={[styles.txt_name, { marginLeft: 1 }]}>
                          {item.u_name}
                        </Text>
                      </View>
                    </View>
      ...
      <Modal animationType="slide" visible={v_schedule}>
        <SafeAreaView style={{ flex: 1 }}>
          <View style={[styles.containterCLD, { backgroundColor: "#ffff" }]}>
            <Text style={styles.label}>Schedule</Text>

            <TouchableOpacity onPress={handleVisibleSchedule}>
      ...
      <Modal animationType="slide" visible={visible_GetWallet}>
        <SafeAreaView>
          <View style={styles.form_wallet}>
            ...
            <ScrollView style={[styles.sv_bottom, { height: 200 }]}>
              {wallet?.map((item, index) => {
                return (
                  <View
                    style={[styles.item_table, { height: 140 }]}
                    key={index}
                  >
                    <View
                      style={{
            ...
            <TouchableOpacity onPress={handleVisibleGetWallet}>
                    ...
                    >
                      ...
                      >
                        ...
                        {Intl.NumberFormat({
                          ...
                          currency: "VND",
                          maximumFractionDigits: 3,
                        }).format(item.tran_money)}{" "}
                        VNĐ
                        {"\n"}
                      </Text>
                      <View style={{}}>
                        <Text style={[styles.txt_name, { marginRight: 20 }]}>
                          Ngày Tạo:{" "}
                        </Text>
                        <Text>
                          {item.tran_created.toString().split("T")[0]}{" "}
                        </Text>
                      ...
                      <View>
                        ...
                        <Text>
                          {item.tran_updated.toString().split("T")[0]}
                        </Text>
                      </View>
                    </View>
                  </View>
              ...
              >
                <View style={styles.row}>
                  ...
                  {type === "link" && func === "getCalendar" && (
                    <TouchableOpacity onPress={handleVisibleCalendar}>
                      <AntDesign name="right" color="#0c0c0c" size={22} />
                    </TouchableOpacity>
                  )}
